export const BaseInfo = {
  ...
  description:
    "Full-stack developer skilled in TypeScript, Node.js, Express.js, and REST APIs. Experienced with MySQL, PostgreSQL, MongoDB, Python, and C++. Focused on building clean, efficient, and scalable web applications",
...
export const aboutInfo = {
  ...
  description:
    "I’m a web developer skilled in building responsive, user-friendly applications with modern teck stacks. I’m passionate about clean code, problem-solving, and continuously expanding my tech expertise",
  client: "3+",
  experience: "1+",
  project: "5+",
  website: "2+",
...
export const contactData = {
  phone: "+92(312 8273955)",
  email: "mehrullah.dev@outlook.com",
